export const SANITY_DRAIN_LOGS = [
  ...
  (monster: string, amount: number) => `The ${monster} moves in a way that suggests it failed geometry class. You lose ${amount} sanity trying to calculate its trajectory.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} smells like burning hair and forgotten dreams.`,
  (monster: string, amount: number) => `The ${monster} looks at you with eyes that have seen the heat death of the universe. You lose ${amount} sanity.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is a reminder that evolution doesn't always have a plan.`,
  (monster: string, amount: number) => `The ${monster} emits a frequency that vibrates your teeth. You lose ${amount} sanity and maybe a filling.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is wearing a hat. Why is it wearing a hat? It's deeply unsettling.`,
  (monster: string, amount: number) => `The ${monster} reminds you of a drawing you made when you were five. A very disturbed five-year-old. You lose ${amount} sanity.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is judging your outfit. You can feel it.`,
  (monster: string, amount: number) => `The ${monster} is a kaleidoscope of horror. You lose ${amount} sanity trying to focus on it.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is what happens when God spills ink on the canvas of creation.`,
  (monster: string, amount: number) => `The ${monster} whispers your search history. You lose ${amount} sanity out of pure embarrassment.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is a physical manifestation of your anxiety.`,
  (monster: string, amount: number) => `The ${monster} is so ugly it loops back around to being... still ugly. You lose ${amount} sanity.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is a rejected design from a horror movie that was too scary to release.`,
  (monster: string, amount: number) => `The ${monster} makes a noise like a wet sponge hitting a chalkboard. You lose ${amount} sanity.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is a walking argument against intelligent design.`,
  (monster: string, amount: number) => `The ${monster} is a glitch in the simulation. You lose ${amount} sanity realizing nothing is real.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is a visual pun that you don't get.`,
  (monster: string, amount: number) => `The ${monster} is a fractal of teeth and eyes. You lose ${amount} sanity counting them.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is a reminder that the universe is vast and indifferent.`,
  (monster: string, amount: number) => `The ${monster} is a biological impossibility. You lose ${amount} sanity trying to classify it.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is a walking Rorschach test, and you see death.`,
  (monster: string, amount: number) => `The ${monster} is a symphony of wrongness. You lose ${amount} sanity listening to it.`,
  (monster: string, amount: number) => `You lose ${amount} sanity. The ${monster} is a cosmic typo.`,
  (monster: string, amount: number) => `The ${monster} is a visual representation of a panic attack. You lose ${amount} sanity.`,
  (monster: string, amount: number) => `You drop ${amount} sanity. The ${monster} is a reminder that you are small and insignificant.`
];
